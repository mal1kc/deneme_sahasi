...
int main()
{
    ...
    while (1)
    {
        ...
        {
            printf("To get 3.14, we have to use %d terms.\n", i);
            check1 = 1;
        }
        if (pi >= 3.141f && pi < 3.142f && check2 == 0)
        {
            printf("To get 3.141, we have to use %d terms.\n", i);
            check2 = 1;
        }
        if (pi >= 3.1415f && pi < 3.1416f && check3 == 0)
        {
            printf("To get 3.1415, we have to use %d terms.\n", i);
            check3 = 1;
        }
        if (pi >= 3.14159f && pi < 3.14160f && check4 == 0)
        {
            printf("To get 3.14159, we have to use %d terms.", i);
            check4 = 1;
        }

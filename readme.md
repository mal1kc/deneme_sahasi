# My Practice Area/ Little Experiments

Repo that contains some little practice/experiment scripts and simple apps

## cVcpp

  * [simple cpp and c programs check dir readme](./cVcpp/readme.md#0-20)

## go (🦙)

  * [a terminal clock example to learn very basic loop,array syntax of language](./go/clock/main.go)
  * [web fileserver (with html file live reloading)](./go/fileserver/main.go)

## powershell

  * [empty directory remover script (edit before run)](./powershell/delete_empyt_dirs.ps1#1-10)

## python (🐍)

  * [binary search implementation](./python/binary_search.py)
  * [pi calculation script](./python/calc_pi.py)
  ...
  * [system hardware info](./python/system_hardwate_info.py)
  * [updating terminal output](./python/updating.terminal.output.py)

## rust (🦀)
  * [a terminal clock example to learn very basic loop,array syntax of language](./rust/clock/src/main.rs)
  * [very simple  cpu stress tester with threading](./rust/cpu_stress/src/main.rs)
...
## weird programming langs things
  ...
  * [check dir readme](./weird_programmingthings/readme.md)
